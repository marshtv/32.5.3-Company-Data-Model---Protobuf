...
PROTOBUF_CONSTEXPR Company::Company(::_pbi::ConstantInitialized)
    : _impl_{
      ...
      /*decltype(_impl_.year_foundation_)*/ 0,
...
const ::uint32_t TableStruct_company_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::Company, _impl_.company_name_),
...
const char descriptor_table_protodef_company_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    "\n\rcompany.proto\"\214\001\n\007Company\022\024\n\014company_n"
    "ame\030\001 \002(\t\022\025\n\rlegal_address\030\002 \002(\t\022\027\n\017year"
    "_foundation\030\003 \002(\005\022\030\n\020type_of_activity\030\004 "
...
Company::Company(const Company& from) : ::google::protobuf::Message() {
  ...
  new (&_impl_) Impl_{
      ...
      decltype(_impl_.legal_address_){},
      decltype(_impl_.type_of_activity_){},
      decltype(_impl_.year_foundation_){},
  ...
  if ((from._impl_._has_bits_[0] & 0x00000004u) != 0) {
    _this->_impl_.type_of_activity_.Set(from._internal_type_of_activity(), _this->GetArenaForAllocation());
  }
  ::memcpy(&_impl_.year_foundation_, &from._impl_.year_foundation_,
    static_cast<::size_t>(reinterpret_cast<char*>(&_impl_.foreign_economic_activity_) -
    reinterpret_cast<char*>(&_impl_.year_foundation_)) + sizeof(_impl_.foreign_economic_activity_));
...
const ::_pbi::TcParseTable<3, 5, 0, 57, 2> Company::_table_ = {
  {
    PROTOBUF_FIELD_OFFSET(Company, _impl_._has_bits_),
    0, // no _extensions_
    ...
    {::_pbi::TcParser::FastSS1,
     {10, 0, 0, PROTOBUF_FIELD_OFFSET(Company, _impl_.company_name_)}},
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(Company, _impl_.year_foundation_), 3>(),
     {24, 3, 0, PROTOBUF_FIELD_OFFSET(Company, _impl_.year_foundation_)}},
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<bool, offsetof(Company, _impl_.foreign_economic_activity_), 4>(),
     {40, 4, 0, PROTOBUF_FIELD_OFFSET(Company, _impl_.foreign_economic_activity_)}},
    {::_pbi::TcParser::MiniParse, {}},
    {::_pbi::TcParser::MiniParse, {}},
  }}, {{
    65535, 65535
    ...
    // required string company_name = 1;
    {PROTOBUF_FIELD_OFFSET(Company, _impl_.company_name_), _Internal::kHasBitsOffset + 0, 0,
    ...
    (0 | ::_fl::kFcOptional | ::_fl::kRawString | ::_fl::kRepAString)},
    // optional bool foreign_economic_activity = 5;
    {PROTOBUF_FIELD_OFFSET(Company, _impl_.foreign_economic_activity_), _Internal::kHasBitsOffset + 4, 0,
...
void Company::InternalSwap(Company* other) {
  ...
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.type_of_activity_, lhs_arena,
